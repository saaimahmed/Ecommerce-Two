...
<div class="modal-content">
    <div class="modal-header ">
        <h2 class="modal-title text-center">Add Brand</h2>
...
{{--                About Text--}}
                <div class="col-md-10 mx-auto">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input name="brand_name" type="text" class="form-control" id="" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="about" class="col-md-4 form-label fw-bolder">Brand Description</label>
                        <div class="col-md-8">
                            <textarea name="brand_description" id="summernote" cols="100" rows="2" ></textarea>
                        </div>
                    </div>
                    {{--                Image--}}
                    <div class="row mb-3">
            ...
            <div class="text-center py-5">
                <button type="submit" class="btn btn-lg btn-success">Create New Brand</button>
            </div>
        </form>
    </div>
</div>
