...
@section('body')
    ...
    <div class="modal-content">
        <div class="modal-header ">
            <h2 class="modal-title text-center">Add Sub Category</h2>
            <button type="button" class="btn-close btn-danger" data-bs-dismiss="modal" onclick="history.back()" aria-label="Close"></button>
        </div>
        <div class="modal-body text-dark">
            <form action="{{ route('create.sub-category') }}" method="POST" class="text-dark" enctype="multipart/form-data" >
                @csrf
                <div class="row">
                    {{--                About Text--}}
                    <div class="col-md-10 mx-auto">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea name="sub_category_description" id="summernote" cols="100" rows="2"></textarea>
                            </div>
                        </div>
                        {{--                Image--}}
                        <div class="row mb-3">
                ...
                <div class="text-center py-5">
                    <button type="submit" class="btn btn-lg btn-success">Create New Sub Category</button>
                </div>
            </form>
        </div>
    </div>
